...
dn::Shape::Shape(const dn::VertexArray &p_vertices, const GLenum &p_method, const dn::IndiceArray &p_indices)
...
GLenum dn::Shape::method() const { return (this->_method); }
void dn::Shape::setMethod(const GLenum &p_method)
{
