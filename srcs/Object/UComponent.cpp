...
dn::UComponent::UComponent(const std::string &p_name, dn::Object *p_object)
	: _object(p_object), _name(p_name), _active(true)
{

}

dn::UComponent::UComponent(dn::Object *p_object, const std::string &p_name)
	: UComponent(p_name, p_object)
{
